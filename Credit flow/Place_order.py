...
class Blitznet_buyer_place_order:
    ...
    # Place order.
    place_order = driver.find_element(By.XPATH,"/html/body/div[2]/div/div/div[3]/div[2]/div[2]/div[1]/div/div/div[3]/div/div/div/div/div/div/div[2]/div/div[2]/div[3]/a").click()
    time.sleep(1)
