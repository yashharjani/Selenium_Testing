    ...
    def get_rfq_no():
        ...
        for r in range(1,15):
            ...
            if buyer_comp_name == "Automation testing academy":
                ...
                return driver.find_element(By.XPATH,"/html/body/div[1]/div/div[2]/div[1]/div[1]/div/div[3]/div/div/div/div[2]/div/div[1]/div[2]/table/tbody/tr["+str(r)+"]/td[3]/a").get_attribute("data-id")
                # print(rfq_no)
                break
