...
class Blitznet_placing_rfq():
    ...
    # driver.find_element(By.ID, "email").send_keys("samle@yopmail.com")
    driver.find_element(By.ID, "password").send_keys("vijaychauhan@yopmail.com")
    # driver.find_element(By.ID, "password").send_keys("sample@yopmail.com")
    ...
    # dropdown = driver.find_element(By.XPATH, "/html/body/div[2]/div/div/div[3]/div[2]/div/form/div[3]/div[1]/div/div[6]/select").click()
    dropdown = driver.find_element(By.ID,"unit").click()
    dropdown = driver.find_element(By.CSS_SELECTOR,"#unit > option:nth-child(4)").click()
    # dropdown = driver.find_element(By.XPATH, "/html/body/div[2]/div/div/div[3]/div[2]/div/form/div[3]/div[1]/div/div[6]/select/option[14]").click()
    ...
    add_product = driver.find_element(By.ID, "product_description").send_keys("Automation")
    ...
    delivery_date = driver.find_element(By.ID,"expected_date").click()
    # 26 | click | id=expected_date | 
    # delivery_date = driver.find_element(By.XPATH,"/html/body/div[2]/div/div/div[3]/div[2]/div/form/div[20]/input").click()
    # 27 | click | linkText=24 | 
    delivery_date =  driver.find_element(By.LINK_TEXT, "30").click()
    time.sleep(1)
    ...
    time.sleep(1)
    preferred_supplier = driver.find_element(By.ID,"inlineRadio2").click()
    # preferred_supplier = driver.find_element(By.XPATH,"/html/body/div[2]/div/div/div[3]/div[2]/div/form/div[29]/div/div[1]/div[2]/input").click()
    time.sleep(1)
    # 29 | click | id=showPreferredSuppliers | 
    # driver.find_element(By.ID, "showPreferredSuppliers").click()
    # time.sleep(2)
    # # 30 | click | id=showPreferredSuppliers | 
    # driver.find_element(By.ID, "showPreferredSuppliers").click()
    # time.sleep(2)
